...
exports.StyledSpinnerSpan = exports.StyledSpinnerContainer = exports.StyledSpinner = exports.StyledLoadingLabel = exports.StyledLoadingContainer = exports.StyledLoading = void 0;

var _stitches = require("../theme/stitches.config");

const loadingBlink = (0, _stitches.keyframes)({
  '0%': {
    opacity: '0.2'
  },
  '20%': {
...
const rotate = (0, _stitches.keyframes)({
  '0%': {
...
const points = (0, _stitches.keyframes)({
  '0%': {
...
const spinner = (0, _stitches.keyframes)({
  '0%': {
    opacity: 1
  },
  '100%': {
...
const StyledLoadingContainer = (0, _stitches.styled)('div', {
  d: 'inline-flex',
  fd: 'column',
  ai: 'center',
  position: 'relative',
...
const StyledSpinnerContainer = (0, _stitches.styled)('div', {
  size: '100%',
  position: 'relative',
  left: '50%',
  top: '50%'
...
const StyledSpinner = (0, _stitches.styled)('div', {
  d: 'flex',
  fd: 'column',
  jc: 'center',
  ai: 'center',
...
const StyledSpinnerSpan = (0, _stitches.styled)('span', {
  bg: '$$loadingColor',
  position: 'absolute',
  top: '-3.9%',
  width: '24%',
...
exports.StyledSpinnerSpan = StyledSpinnerSpan;
const StyledLoading = (0, _stitches.styled)('span', {
  position: 'absolute',
  top: 0,
  left: 0,
  right: 0,
...
const StyledLoadingLabel = (0, _stitches.styled)('label', {
  mt: '$1',
...
exports.StyledLoadingLabel = StyledLoadingLabel;