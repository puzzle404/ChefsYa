...
exports.StyledPaginationItemContent = exports.StyledPaginationItem = exports.StyledPaginationIcon = exports.StyledPaginationHighlight = exports.StyledPaginationEllipsis = exports.StyledPagination = void 0;

var _stitches = require("../theme/stitches.config");

var _color = require("./../utils/color");

var _theme$colors, _theme$colors$accents;

const paginationAnimation = (0, _stitches.keyframes)({
  '0%': {
    transform: 'scale(1)'
  },
  '60%': {
...
const StyledPaginationEllipsis = (0, _stitches.styled)('svg', {
  color: 'currentColor',
  stroke: 'currentColor',
  variants: {
    isEllipsis: {
...
exports.StyledPaginationEllipsis = StyledPaginationEllipsis;
const StyledPaginationIcon = (0, _stitches.styled)('svg', {
  transform: 'rotate(180deg)',
  variants: {
    isPrev: {
      true: {
...
exports.StyledPaginationIcon = StyledPaginationIcon;
const StyledPaginationItemContent = (0, _stitches.styled)('span', {
  position: 'relative',
  display: 'inline-flex',
  alignItems: 'center',
  top: 0,
...
exports.StyledPaginationItemContent = StyledPaginationItemContent;
const StyledPaginationItem = (0, _stitches.styled)('button', {
  border: 'none',
  position: 'relative',
  display: 'inline-flex',
  ...
  '&:hover': {
    bg: (0, _color.addColorAlpha)((_theme$colors = _stitches.theme.colors) == null ? void 0 : (_theme$colors$accents = _theme$colors.accents3) == null ? void 0 : _theme$colors$accents.value, 0.3)
  },
...
exports.StyledPaginationItem = StyledPaginationItem;
const StyledPaginationHighlight = (0, _stitches.styled)('div', {
  position: 'absolute',
  contain: 'strict',
  top: '0px',
  zIndex: '$1',
...
exports.StyledPaginationHighlight = StyledPaginationHighlight;
const StyledPagination = (0, _stitches.styled)('nav', {
  m: 0,
  p: 0,
  d: 'inline-flex',
  position: 'relative',
